  ...
  const books = [
    {
      ...
      description: "A profound exploration of the workings of the Holy Spirit in the life of a believer. This book unveils the dynamics of spiritual growth, power, and intimacy with God. Discover how to flow with the Spirit, operate in spiritual gifts, and experience a deeper dimension of your faith.",
      ...
      variants: [
        { format: "HARDCOPY", price: 14.99, comparePrice: 19.99, stock: 50 },
        { format: "SOFTCOPY", price: 9.99, comparePrice: 14.99, stock: 999 },
        { format: "AUDIO_BOOK", price: 11.99, comparePrice: 16.99, stock: 999 },
      ],
    },
    {
      ...
      author: "Dr. Isaiah Wealth",
      description: "Unlock the transformative power of prayer in your daily life. From intercession to spiritual warfare, this comprehensive guide teaches you how to pray effectively and see results.",
      ...
      variants: [
        { format: "HARDCOPY", price: 16.99, comparePrice: 21.99, stock: 45 },
        { format: "SOFTCOPY", price: 11.99, comparePrice: 16.99, stock: 999 },
      ],
    },
    {
      ...
      author: "Dr. Isaiah Wealth",
      description: "A life-changing book about the power of transformation through Christ. Metanoia — a fundamental shift of mind, heart, and life direction. Learn how to embrace God's transformative power.",
      ...
      variants: [
        { format: "HARDCOPY", price: 13.99, comparePrice: 0, stock: 60 },
        { format: "SOFTCOPY", price: 8.99, comparePrice: 0, stock: 999 },
        { format: "AUDIO_BOOK", price: 10.99, comparePrice: 0, stock: 999 },
      ],
    },
    {
      ...
      author: "Dr. Isaiah Wealth",
      description: "Discover the principles of faith that move mountains. This book teaches you how to develop a strong faith life, speak words of faith, and see God's promises manifest in your life.",
      ...
      variants: [
        { format: "HARDCOPY", price: 15.99, comparePrice: 20.99, stock: 40 },
        { format: "SOFTCOPY", price: 10.99, comparePrice: 15.99, stock: 999 },
      ],
    },
    {
      ...
      author: "Dr. Isaiah Wealth",
      description: "A comprehensive guide to understanding and operating in the prophetic ministry. Learn how to hear God's voice, discern spirits, and deliver prophetic words with accuracy and love.",
      ...
      variants: [
        { format: "HARDCOPY", price: 17.99, comparePrice: 22.99, stock: 35 },
        { format: "SOFTCOPY", price: 12.99, comparePrice: 17.99, stock: 999 },
        { format: "AUDIO_BOOK", price: 14.99, comparePrice: 19.99, stock: 999 },
      ],
    },
    {
      ...
      author: "Dr. Isaiah Wealth",
      description: "Biblical principles for effective leadership in God's kingdom. This book equips leaders with the tools to influence, inspire, and impact their generation for Christ.",
      ...
      variants: [
        { format: "HARDCOPY", price: 14.99, comparePrice: 0, stock: 30 },
        { format: "SOFTCOPY", price: 9.99, comparePrice: 0, stock: 999 },
      ],
    },
    {
      ...
      author: "Dr. Isaiah Wealth",
      description: "A verse-by-verse study guide that makes Scripture accessible and applicable to daily life. Perfect for personal study or small group discussions.",
      ...
      variants: [
        { format: "HARDCOPY", price: 19.99, comparePrice: 24.99, stock: 25 },
        { format: "SOFTCOPY", price: 14.99, comparePrice: 19.99, stock: 999 },
      ],
    },
    {
      ...
      author: "Dr. Isaiah Wealth",
      description: "Building a God-centered marriage that stands the test of time. This book offers practical wisdom for couples at every stage of their relationship journey.",
      ...
      variants: [
        { format: "HARDCOPY", price: 12.99, comparePrice: 16.99, stock: 55 },
        { format: "SOFTCOPY", price: 7.99, comparePrice: 11.99, stock: 999 },
      ],
    },
    {
      ...
      author: "Dr. Isaiah Wealth",
      description: "A year-long devotional journey through Scripture. Each day offers a reading, reflection, and prayer to draw you closer to God.",
      ...
      variants: [
        { format: "HARDCOPY", price: 11.99, comparePrice: 0, stock: 70 },
        { format: "SOFTCOPY", price: 6.99, comparePrice: 0, stock: 999 },
      ],
    },
    {
      ...
      author: "Dr. Isaiah Wealth",
      description: "Scripture-based prayers that get results. This powerful prayer manual covers every area of life with prayers rooted in God's Word.",
      ...
      variants: [
        { format: "HARDCOPY", price: 10.99, comparePrice: 14.99, stock: 80 },
        { format: "SOFTCOPY", price: 5.99, comparePrice: 9.99, stock: 999 },
        { format: "AUDIO_BOOK", price: 7.99, comparePrice: 11.99, stock: 999 },
      ],
    },
  ];
  ...
  for (const book of books) {
    ...
    for (const v of book.variants) {
      await prisma.bookVariant.upsert({
        where: { bookId_format: { bookId: created.id, format: v.format as any } },
        update: {},
        create: {
          bookId: created.id,
